...
## Get subset of patients expressing ROR2 or not (P3, P5, P8)
...
## Jingjing suggestion:
## top10 varying genes, but as dotplots to determine precise subpopulations
...
# PDL1 (CD274) CD62L (SELL) ADGRE1 (EMR1, F4/80)
